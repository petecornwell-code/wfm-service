...
- [ ] **Phase 15: Shift Envelope & Coupling** - The solver assigns one shift per agent-day via a hard-constraint coupling proven sound, with its quality effect benchmarked honestly
